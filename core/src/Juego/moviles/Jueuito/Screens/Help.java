...
public class Help implements Screen {
    ...
    public Help(final MainClass mainClass) {
        ...
        lblMano = UICrea.createLabel(lang.get("help.hand"),20, Color.BLACK,new Vector2(WORLD_WIDTH*0.3f,WORLD_HEIGHT*0.85f),stage);
        lblExplicacion = UICrea.createLabel(lang.get("help.opjetive"),20, Color.BLACK,new Vector2(WORLD_WIDTH*0.03f,WORLD_HEIGHT*0.5f),stage);
